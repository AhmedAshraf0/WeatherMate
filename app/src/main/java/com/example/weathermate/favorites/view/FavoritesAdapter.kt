...
class FavoritesAdapter: ListAdapter<FavoriteWeatherResponse, FavoritesAdapter.ViewHolder>(DiffUtilFavorites()){

    inner class ViewHolder(var cardFavoriteBinding: CardFavoriteBinding) :
        RecyclerView.ViewHolder(cardFavoriteBinding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoritesAdapter.ViewHolder = ViewHolder(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cardFavoriteBinding.tvFavDeg.text = Converter.convertDoubleToIntString(currentFavCard.temp)
